...
class FlowMatchingModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        predicted_field = self(x_t, condition_param, total_mass)
    ...
    def sample(self, total_mass, astro_params, total_mass_condition, num_steps=100, method='euler'):
        ...
        with torch.no_grad():
            for i in range(num_steps):
                ...
                field_change = self(x, combined_condition, total_mass_condition)
