...
class AstroFlowMatchingDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.train_dataset = AstroMapDataset(train_total_mass, train_star_maps, train_gas_maps)
        self.val_dataset = AstroMapDataset(val_total_mass, val_star_maps, val_gas_maps)
...
class FlowMatchingModel(pl.LightningModule):
    ...
    def __init__(self, 
        ...
        self.scalar_field = UNetScalarField(in_channels=4, out_channels=2) 
