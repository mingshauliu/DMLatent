...
class UNetScalarField(nn.Module):
    def __init__(self, in_channels=2, base_channels=64, out_channels=3):
        ...
        condition_dim = 8 + 8 + 8  # time + mass_condition + astro_condition + resnet_embedding
    ...
    def forward(self, x, combined_condition, resnet_embed):
        ...
        combined_embed = torch.cat([time_embed, param_embed, resnet_embed], dim=1)  # (batch, 256)
