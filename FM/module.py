...
class FlowMatchingModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        predicted_field = self(x_t, condition_param, total_mass, resnet_input)
    ...
    def sample(self, total_mass, astro_params, total_mass_condition, resnet_input, num_steps=100, method='euler'):
        ...
        x = total_mass.expand(-1,2,-1,-1).clone()
        dt = 1.0 / num_steps
        ...
        with torch.no_grad():
            for i in range(num_steps):
                ...
                field_change = self(x, combined_condition, total_mass_condition, resnet_input)
