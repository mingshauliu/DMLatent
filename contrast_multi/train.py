...
def setup_hierarchical_data_paths():
    """Setup paths for all 8 component types - UPDATE THESE"""
    return {
        'gas_cdm': '/path/to/gas_cdm_maps.npy',
        'gas_wdm': '/path/to/gas_wdm_maps.npy',
        'stars_cdm': '/path/to/stars_cdm_maps.npy',
        'stars_wdm': '/path/to/stars_wdm_maps.npy',
        'dm_cdm': '/path/to/dm_cdm_maps.npy',
        'dm_wdm': '/path/to/dm_wdm_maps.npy',
...
# callbacks.py - Enhanced callbacks for hierarchical visualization
